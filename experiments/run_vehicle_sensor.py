...
from datasets.vehicle_sensor import VehicleSensorDataset
...
def main(args):
    ...
    # Prepare dataset
    print("Preparing Vehicle Sensor dataset...")
    dataset = VehicleSensorDataset(
    ...
    if args.visualize_graph:
        visualize_graph(graph, title=f"Vehicle Sensor - {args.graph_type} Graph")
    ...
    if args.save_results:
        save_path = f"results/sheaf_fmtl_vehicle_gamma{args.gamma}.json"
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Sheaf-FMTL on Vehicle Sensor Dataset")
    
    # Dataset parameters
    parser.add_argument('--data_path', type=str, default='data/vehicle.mat',
                        help='Path to vehicle dataset')
    ...
    parser.add_argument('--alpha', type=float, default=0.01, help='Learning rate for models')
    parser.add_argument('--eta', type=float, default=0.05, help='Learning rate for restriction maps')
    parser.add_argument('--gamma', type=float, default=0.1, help='Compression factor for interaction space')
