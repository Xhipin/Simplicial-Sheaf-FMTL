...
class SimplicialSheafFMTL:
    """
    Sheaf-based Federated Multi-Task Learning Algorithm
    
    Args:
        models: List of client models
        graph: NetworkX graph representing client connectivity ## TODO: This will be changed because simplicial complexes have more complex structure
    ...
    def sheaf_update(self, client_id: int):
        ...
        with torch.no_grad():
            ...
            ## Here implement the simplicial update
